...
import io.github.emmrida.chat4us.util.CertificateConverter;
...
/**
 * This is used to import an external certificate to secure communication between chat server instances,
		...
		gl_panel_2.setHorizontalGroup(
			gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addGap(6)
					.addComponent(tfCurPsWd, GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE)
					.addGap(6))
		);
																									...
																									gl_panel_1.createParallelGroup(Alignment.LEADING)
																										.addGroup(gl_panel_1.createSequentialGroup()
																											...
																											.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
																												.addGroup(gl_panel_1.createSequentialGroup()
																													.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
																														.addComponent(tfConfPswd, GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE)
																														.addComponent(tfNewPswd, GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE))
																													.addGap(1)
																													.addGroup(gl_panel_1.createParallelGroup(Alignment.TRAILING)
																												...
																												.addComponent(tfAlias, GroupLayout.DEFAULT_SIZE, 327, Short.MAX_VALUE))
																											.addGap(6))
																								);
																...
																gl_panel.setHorizontalGroup(
																	gl_panel.createParallelGroup(Alignment.LEADING)
																		.addGroup(gl_panel.createSequentialGroup()
																			...
																			.addGap(6)
																			.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
																				.addComponent(tfCertPswd, GroupLayout.DEFAULT_SIZE, 318, Short.MAX_VALUE)
																				.addGroup(gl_panel.createSequentialGroup()
																					.addComponent(tfKeyPath, GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
																					.addPreferredGap(ComponentPlacement.RELATED)
																					.addComponent(btnKeyChooser, GroupLayout.PREFERRED_SIZE, 45, GroupLayout.PREFERRED_SIZE))
																				.addGroup(gl_panel.createSequentialGroup()
																					.addComponent(tfCertPath, GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
																					.addPreferredGap(ComponentPlacement.RELATED)
																	...
																	gl_panel.createParallelGroup(Alignment.LEADING)
																		.addGroup(gl_panel.createSequentialGroup()
																			...
																			.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
																				...
																				.addComponent(btnCertChooser, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
																				.addComponent(lblCertPath))
																			.addPreferredGap(ComponentPlacement.RELATED)
																			.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
																				.addComponent(btnKeyChooser, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE)
