			...
			gl_pnlOnSuccess.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlOnSuccess.createSequentialGroup()
					...
					.addGroup(gl_pnlOnSuccess.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(tfSuccessValue, GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE)
						.addComponent(cmbSuccessAction, 0, 248, Short.MAX_VALUE)
						.addGroup(gl_pnlOnSuccess.createSequentialGroup()
			...
			gl_pnlOnError.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_pnlOnError.createSequentialGroup()
					...
					.addGroup(gl_pnlOnError.createParallelGroup(Alignment.LEADING)
						.addComponent(scrollPane_1_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(cmbErrorAction, 0, 261, Short.MAX_VALUE)
						.addComponent(tfErrorValue, GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
						.addGroup(gl_pnlOnError.createSequentialGroup()
